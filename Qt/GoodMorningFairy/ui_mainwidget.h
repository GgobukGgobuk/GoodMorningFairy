...
public:
    ...
    void setupUi(QWidget *MainWidget)
    {
        ...
        pTab8 = new QWidget();
        pTab8->setObjectName(QString::fromUtf8("pTab8"));
        pTabWidget->addTab(pTab8, QString());
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        pTabWidget->setTabText(pTabWidget->indexOf(pTab2), QApplication::translate("MainWidget", "Tab 2", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab3), QApplication::translate("MainWidget", "Tab 3", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab4), QApplication::translate("MainWidget", "Tab 4", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab5), QApplication::translate("MainWidget", "Tab 5", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab6), QApplication::translate("MainWidget", "Tab 6", nullptr));
        pTabWidget->setTabText(pTabWidget->indexOf(pTab8), QApplication::translate("MainWidget", "Tab 8", nullptr));
    } // retranslateUi
