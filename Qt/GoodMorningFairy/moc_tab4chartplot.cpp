...
QT_MOC_LITERAL(1, 14, 12), // "chartPlotAdd"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 14), // "chartPlotClear"
QT_MOC_LITERAL(4, 43, 16), // "slotTab4RecvData"
QT_MOC_LITERAL(5, 60, 18) // "updateLastDateTime"

    },
    "Tab4ChartPlot\0chartPlotAdd\0\0chartPlotClear\0"
    "slotTab4RecvData\0updateLastDateTime"
};
...
void Tab4ChartPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chartPlotAdd(); break;
        case 1: _t->chartPlotClear(); break;
        case 2: _t->slotTab4RecvData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->updateLastDateTime((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
