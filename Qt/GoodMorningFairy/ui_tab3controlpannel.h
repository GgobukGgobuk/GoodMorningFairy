...
public:
    ...
    void setupUi(QWidget *Tab3ControlPannel)
    {
        ...
        Tab3ControlPannel->resize(567, 366);
        ...
        pPBPlug->setGeometry(QRect(320, 190, 71, 71));
        QIcon icon1;
        ...
        formLayout_2->setWidget(0, QFormLayout::LabelRole, scrollArea);
    ...
    {
        Tab3ControlPannel->setWindowTitle(QApplication::translate("Tab3ControlPannel", "Form", nullptr));
